...
const sections = [
  ...
  { title: 'Intellectual Property', content: 'The Services and their entire contents, features, and functionality are owned by Redwood Crest, its licensors, or other providers of such material and are protected by United States and international copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws. The Redwood Crest name, logo, and all related names, logos, product and service names, designs, and slogans are used here as part of a personal portfolio project.' },
    ...
    <InfoPageShell title="Terms of Use">
      <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-5 mb-8 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">Please read these terms carefully before using this site. Redwood Crest is a personal software engineering portfolio project, not a real financial institution. The terms below are a sample document for demonstration purposes.</p>
        </div>
      </div>
      ...
      <div className="mt-10 border-t border-gray-200 pt-6 text-center text-sm text-gray-500">
        <p>If you have questions about these Terms of Use, contact us at support@redwoodcrestinc.com</p>
      </div>
    </InfoPageShell>
  );
}
